...
<b>From&nbsp;</b>
	<custom:hello url="jdbc:postgresql://192.168.110.48:5432/plf_training" user="plf_training_admin" password="pff123" table="mystations" displayColumn="trn_start" valueColumn="trn_start"/>

</td >
<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td style="padding-bottom: 20px;"><b>To</b>&nbsp;	
<custom:hello  url="jdbc:postgresql://192.168.110.48:5432/plf_training" user="plf_training_admin" password="pff123" table="mystations" displayColumn="trn_end" valueColumn="trn_end"/>

</td>
</tr>
<tr>
<td style="padding-bottom: 20px;" colspan="3"><b>Train Name</b>&nbsp;
<custom:hello  url="jdbc:postgresql://192.168.110.48:5432/plf_training" user="plf_training_admin" password="pff123" table="mystations" displayColumn="trn_name" valueColumn="trn_no"/>

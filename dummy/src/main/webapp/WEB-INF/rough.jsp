...
input[type="number"] {
    ...
    function saveFormData(tabIndex) {
        const form = document.getElementById(`form-part-${tabIndex}`);
        ...
        sessionStorage.setItem(`formData-${tabIndex}`, JSON.stringify(data));
    }
            ...
            <div class="form-part" style="display: none;">
                <form id="form-part-2">
                    ...
                    <button type="button" style= "background-color: green;
										        ...
										        border-radius: 5px;
										        transition: background-color 0.3s;" 
										        onclick="prevTab(1)">Previous</button>
                </form>
            </div>
            <div class="form-part" style="display: none;">
                <form id="form-part-3">
                	<b>Nominee Name:</b>
                    <input type="text" name="nn" placeholder="Enter nominee name"><br>
                    <b>Nominee Relation:</b>
                    <input type="text" name="nr" placeholder="Enter nominee relation"><br>
                    <button class="form-button" type="button" onclick="prevTab(2)">Previous</button>
					<button class="form-button" type="button" onclick="saveFormData(2); document.getElementById('form-part-3').submit();">Submit</button>
                </form>
            </div>
        </div>
    </div>
